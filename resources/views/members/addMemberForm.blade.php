...
@section('content')
    @include('includes.addMemberFormHeader')
    ...
    @else
       <div class="row">
           <form action="{{route('addMember')}}" method="POST" class="felx col-sm-8 col-11 mx-auto flex-column my-5" enctype="multipart/form-data">
               @csrf
               <div class="mb-3">
                   <label for="name" class="form-label text-light text-capitalize font-weight-bold" style="font-size: calc(10px + 0.9vw);">Name <span class="text-danger">*</span></label>
               ...
               <div class="mb-3">
                   <label for="exampleInputEmail1" class="form-label text-light text-capitalize font-weight-bold" style="font-size: calc(10px + 0.9vw);">E-mail <span class="text-danger">*</span></label>
               ...
               <div class="mb-3">
                   <label for="phone" class="form-label text-light text-capitalize font-weight-bold" style="font-size: calc(10px + 0.9vw);">Phone Number(what'sApp available) <span class="text-danger">*</span></label>
               ...
               <div class="mb-3">
                   <label for="university" class="form-label text-light text-capitalize font-weight-bold" style="font-size: calc(10px + 0.9vw);">University or School <span class="text-danger">*</span></label>
               ...
               <div class="mb-3">
                   <label for="faculty" class="form-label text-light text-capitalize font-weight-bold" style="font-size: calc(10px + 0.9vw);">Faculty</label>
               ...
               <div class="mb-3">
                   <label for="department" class="form-label text-light text-capitalize font-weight-bold" style="font-size: calc(10px + 0.9vw);">Department</label>
               ...
               <div class="mb-3">
                   <label for="academic_year" class="form-label text-light text-capitalize font-weight-bold" style="font-size: calc(10px + 0.9vw);">Academic Year <span class="text-danger">*</span></label>
               ...
               <div class="mb-3">
                   <label for="facebook_profile_link" class="form-label text-light text-capitalize font-weight-bold" style="font-size: calc(10px + 0.9vw);">facebook profile link <span class="text-danger">*</span></label>
               ...
               <div class="mb-3">
                   <label for="living_area" class="form-label text-light text-capitalize font-weight-bold" style="font-size: calc(10px + 0.9vw);">Living Area <span class="text-danger">*</span></label>
               ...
               <div class="mb-3">
                   <label for="first_question" class="form-label text-light text-capitalize font-weight-bold" style="font-size: calc(10px + 0.9vw);">What do you know about Pixels? <span class="text-danger">*</span></label>
               ...
               <div class="mb-3">
                   <label for="first_preference_committee" class="form-label text-light text-capitalize font-weight-bold" style="font-size: calc(10px + 0.9vw);">First Preference Committee <span class="text-danger">*</span></label>
               ...
               <div class="mb-3" style="display: none;">
                   <label for="second_question" class="form-label text-light text-capitalize font-weight-bold" style="font-size: calc(10px + 0.9vw);">Why do you want to join this committee? <span class="text-danger">*</span></label>
               ...
               <div class="mb-3" style="display: none;">
                   <label for="first_preference_committee_first_answer" id="first_preference_committee_first_question" class="form-label text-light text-capitalize font-weight-bold" style="font-size: calc(10px + 0.9vw);"></label>
               ...
               <div class="mb-3" style="display: none;">
                   <label for="first_preference_committee_second_answer" id="first_preference_committee_second_question" class="form-label text-light text-capitalize font-weight-bold" style="font-size: calc(10px + 0.9vw);"></label>
               ...
               <div class="mb-3" style="display: none;">
                   <label for="second_preference_committee" class="form-label text-light text-capitalize font-weight-bold" style="font-size: calc(10px + 0.9vw);">second Preference Committee <span class="text-danger">*</span></label>
               ...
               <button type="submit" class="btn btn-dark w-25 py-3 w-100 d-block mx-auto text-center" style="font-size: calc(10px + 0.6vw);">Submit</button>
           </form>
       </div>
    @endif
